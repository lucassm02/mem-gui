...
const ViewDataModal = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
      <div className={`p-5 rounded-lg shadow-lg w-[90%] max-w-xl border transition-all
        ...
        {[
          ...
          { label: "EXPIRAÇÃO", value: itemToView.timeUntilExpiration, field: "expiration" },
        ...
        <div className="mt-4">
          <label className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>FORMATO:</label>
          <select
            id="format-selector"
        ...
        <div className={`p-3 rounded-md border mt-4 max-h-72 overflow-auto transition
